export const ICONS = {
  star: '<path d="M14.85 3a.5.5 0 0 0-.5.5v1.94a.5.5 0 0 0 .5.5h1.93a.5.5 0 0 0 .5-.5V3.5a.5.5 0 0 0-.5-.5h-1.93Z" fill="currentColor"/><path d="M11.62 4 7.65 11.4l-7.5-7.4 11.47 0Z"/><path d="M8 .25a.75.75 0 0 1 .673.418l1.882 3.815 4.21.612a.75.75 0 0 1 .416 1.279l-3.046 2.97.719 4.192a.75.75 0 0 1-1.088.791L8 12.347l-3.766 1.98a.75.75 0 0 1-1.088-.79l.72-4.194L.818 6.374a.75.75 0 0 1 .416-1.28l4.21-.611L7.327.668A.75.75 0 0 1 8 .25Z"/>',
  commit:
